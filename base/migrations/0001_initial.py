    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', django_resized.forms.ResizedImageField(crop=None, default='profile.jpg', force_format=None, keep_meta=True, quality=-1, scale=None, size=[300, 300], upload_to='')),
